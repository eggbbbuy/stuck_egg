...
STOCKS = [
    ...
    ("2368", "金像電", "高階 PCB（衛星供應鏈）"),
    ("6271", "同欣電", "RF 模組封裝（衛星）"),
    ("3491", "昇達科", "微波元件 / 波導（衛星純度最高）"),
    ("2314", "台揚", "衛星地面站 / 天線設備"),
    ("6285", "啟碁", "衛星終端 / 相位陣列天線"),
    ("3419", "譁裕", "天線（衛星）"),
    ("3105", "穩懋", "GaAs 化合物半導體（衛星 RF）"),
    ("8086", "宏捷科", "GaAs 化合物半導體（衛星 RF）"),
    ("2455", "全新", "磊晶 / 化合物半導體（衛星 RF）"),
    ("2059", "川湖", "精密機構 / 滑軌（SpaceX 傳聞）"),
    ("3178", "公準", "精密加工 / 散熱（SpaceX 傳聞）"),
    ("3653", "健策", "均熱片 / 散熱（衛星 / SpaceX）"),
    ("5388", "中磊", "衛星終端 CPE（網通）"),
    ("3596", "智易", "衛星終端 CPE（網通）"),
    ("3665", "貿聯-KY", "線束 / 連接器（Starlink 傳聞）"),
]
